...
<template>
  <div class="flex flex-wrap gap-2">
    ...
    >
      <svg viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1.5" class="w-3.5 h-3.5 shrink-0">
    ...
    >
      <svg v-if="shape.icon === 'box'" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" class="w-3.5 h-3.5 shrink-0">
      ...
      <svg v-else-if="shape.icon === 'cylinder'" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" class="w-3.5 h-3.5 shrink-0">
      ...
      <svg v-else-if="shape.icon === 'half-sphere'" viewBox="0 0 20 20" fill="none" stroke="currentColor" stroke-width="1" class="w-3.5 h-3.5 shrink-0">
